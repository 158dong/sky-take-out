...
import com.sky.WebSokect.WebSocketServer;
...
public class OrderServiceImpl implements OrderService {
    ...
    public void orderConfirm(OrdersConfirmDTO ordersConfirmDTO) {
        Orders TradeNo = orderMapper.getById(ordersConfirmDTO.getId());
        ...
        Map m = new HashMap();
        m.put("type",1);
        m.put("orderId",ordersConfirmDTO.getId());
        m.put("content","订单号"+TradeNo.getNumber());
    ...
    public void reminder(Long id) {
        ...
        m.put("type",2);
        m.put("orderId",id);
        m.put("content","订单信息"+ordersDB.getNumber());

        webSocketServer.sendToAllClient(JSON.toJSONString(m));
    }
